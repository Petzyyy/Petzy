...
class _VeterinaryBookingProccessFilterScreenState extends BaseRouteState {
  ...
  bool clinicSelected = false;
  bool phonecallSelected = false;
  ...
  int endRangeVal = 150;
  int sliderValInint;
  RangeValues sliderVal5 = const RangeValues(0, 30);

  _VeterinaryBookingProccessFilterScreenState() : super();
